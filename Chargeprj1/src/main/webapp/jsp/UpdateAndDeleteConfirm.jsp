...
<body onload="initialize();">
    <div class="container-fluid">
        <div id="mySidenav" class="sidenav">
            ...
            <a href="/Chargeprj1/index.jsp">首頁</a> <a
				href="insert_form.do">新增</a> <a
				href="query_form.do">查詢</a> <a
				href="/Chargeprj1/Statistic.html">統計</a>
        ...
        <div class="col-xs-12">
            ...
            <form id ="Del" method="POST" action="/Chargeprj1/remove.do">
                <h2>刪除<br/></h2>
            ...
            <form id="Update" method="POST" action="/Chargeprj1/update.do"/>
            <h2>修改<br/></h2>
            <p>請輸入要修改的ID<br/>
                <input type="text" name="idCharge">
            </p>
